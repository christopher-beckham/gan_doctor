...
class GenInitialBlock(th.nn.Module):
    ...
    def __init__(self, in_channels, norm_layer, use_eql=True):
        """
...
class DisFinalBlock(th.nn.Module):
    ...
    def __init__(self, in_channels, use_eql=True, use_sn=False):
        """
        ...
        if use_sn:
            if use_eql:
                raise Exception("Spectral norm can only be used if EQL is turned off")
...
class DisGeneralConvBlock(th.nn.Module):
    ...
    def __init__(self, in_channels, out_channels, use_eql=True, use_sn=False):
        """
        constructor of the class
        :param in_channels: number of input channels
