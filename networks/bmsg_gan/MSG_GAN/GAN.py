...
class Generator(th.nn.Module):
    ...
    def __init__(self, depth=7, latent_size=512, use_eql=True, norm_layer=None):
        """
        ...
        from .CustomLayers import GenGeneralConvBlock, \
...
class Discriminator(th.nn.Module):
    ...
    def __init__(self, depth=7, feature_size=512,
                 use_eql=True, gpu_parallelize=False, sigm=False, use_sn=False):
        """
