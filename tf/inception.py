...
# Modified to support arbitrary batch sizes, as per:
# https://github.com/openai/improved-gan/pull/40/commits/0a09faccb45088695228bbf50435ee71e94eb2ce
...
def _init_inception():
  ...
  with tf.gfile.FastGFile(os.path.join(
    ...
    graph_ = tf.import_graph_def(graph_def)
